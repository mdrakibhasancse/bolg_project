...
@section('content')
  ...
  <div class="cool-facts-area section-padding-100-0 bg-img background-overlay" style="background-image">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="single-blog-area blog-style-2 text-center mb-100">
                    ...
                    <div class="single-blog-content">
                        <div class="line"></div>
                       <a href="javascript:void()" class="post-tag">{{ $search }} (Total Post : {{ $posts->count()}})</a>
                    </div>
                </div>
            </div>
        </div>
